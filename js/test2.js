document.addEventListener("DOMContentLoaded", function () {
    ...
    let checkpersecond = localStorage.getItem('persecond')
    ...
    //check if game is played before
    checkLocale();

    function checkLocale() {
        if (checkpersecond == null) {
            //run game functions as with new game
            overTime();
            storeGameElements();
            available();
        } else {
            //change all variables to saved gamestate
            let scoreString = localStorage.getItem('score');
            let clicksString = localStorage.getItem('clicks');
            let perSecondString = localStorage.getItem('persecond');
            let cursorPriceString = localStorage.getItem('cursorprice');
            let cursorAmountString = localStorage.getItem('cursoramount');
            let cursorMultiplierString = localStorage.getItem('cursormultiplier');
            let cursorMathString = localStorage.getItem('cursormath');
            let cursorShownPriceString = localStorage.getItem('cursorshownprice');
            let grandmaPriceString = localStorage.getItem('grandmaprice');
            let grandmaAmountString = localStorage.getItem('grandmaamount');
            let grandmaMultiplierString = localStorage.getItem('grandmamultiplier');
            let grandmaMathString = localStorage.getItem('grandmamath');
            let grandmaShownPriceString = localStorage.getItem('grandmashownprice');
            let farmPriceString = localStorage.getItem('farmprice');
            let farmAmountString = localStorage.getItem('farmamount');
            let farmMultiplierString = localStorage.getItem('farmmultiplier');
            let farmMathString = localStorage.getItem('farmmath');
            let farmShownPriceString = localStorage.getItem('farmshownprice');
            let minePriceString = localStorage.getItem('mineprice');
            let mineAmountString = localStorage.getItem('mineamount');
            let mineMultiplierString = localStorage.getItem('minemultiplier');
            let mineMathString = localStorage.getItem('minemath');
            let mineShownPriceString = localStorage.getItem('mineshownprice');

            score = parseInt(scoreString, 10);
            clicks = parseInt(clicksString, 10);
            perSecond = parseFloat(perSecondString, 10);
            cursorPrice = parseFloat(cursorPriceString, 10);
            cursorAmount = parseInt(cursorAmountString, 10);
            cursorMultiplier = parseInt(cursorMultiplierString, 10);
            cursorMath = parseFloat(cursorMathString, 10);
            cursorShownPrice = parseFloat(cursorShownPriceString, 10);
            grandmaPrice = parseFloat(grandmaPriceString, 10);
            grandmaAmount = parseInt(grandmaAmountString, 10);
            grandmaMultiplier = parseInt(grandmaMultiplierString, 10);
            grandmaMath = parseFloat(grandmaMathString, 10);
            grandmaShownPrice = parseFloat(grandmaShownPriceString, 10);
            farmPrice = parseFloat(farmPriceString, 10);
            farmAmount = parseInt(farmAmountString, 10);
            farmMultiplier = parseInt(farmMultiplierString, 10);
            farmMath = parseFloat(farmMathString, 10);
            farmShownPrice = parseFloat(farmShownPriceString, 10);
            minePrice = parseFloat(minePriceString, 10);
            mineAmount = parseInt(mineAmountString, 10);
            mineMultiplier = parseInt(mineMultiplierString, 10);
            mineMath = parseFloat(mineMathString, 10);
            mineShownPrice = parseFloat(mineShownPriceString, 10);
            cursorUpg1 = localStorage.getItem('cursorupg1');
            cursorUpg2 = localStorage.getItem('cursorupg2');
            grandmaUpg1 = localStorage.getItem('grandmaupg1');


            //set all fields to correct price
    ...
    //get players name and write at top left
    ...
    //make sure store buttons work and look good
    ...
    //check if i can buy things or not
    function available() {
        CursorAvailable();
        GrandmaAvailable();
        FarmAvailable();
    ...
    //store game elements every second
    function storeGameElements() {
        localStorage.setItem('score', score);
        localStorage.setItem('persecond', perSecond);
        localStorage.setItem('clicks', clicks);
        localStorage.setItem('cursorprice', cursorPrice);
        localStorage.setItem('cursorprice', cursorPrice);
        localStorage.setItem('cursoramount', cursorAmount);
        localStorage.setItem('cursormultiplier', cursorMultiplier);
        localStorage.setItem('cursormath', cursorMath);
        localStorage.setItem('cursorshownprice', cursorShownPrice);
        localStorage.setItem('grandmaprice', grandmaPrice);
        localStorage.setItem('grandmaamount', grandmaAmount);
        localStorage.setItem('grandmamultiplier', grandmaMultiplier);
        localStorage.setItem('grandmamath', grandmaMath);
        localStorage.setItem('grandmashownprice', grandmaShownPrice);
        ...
        localStorage.setItem('farmmath', farmMath);
        localStorage.setItem('farmshownprice', farmShownPrice);
        localStorage.setItem('mineprice', minePrice);
        localStorage.setItem('mineamount', mineAmount);
        localStorage.setItem('minemultiplier', mineMultiplier);
        localStorage.setItem('minemath', mineMath);
        localStorage.setItem('mineshownprice', mineShownPrice);
        localStorage.setItem('cursorupg1', cursorUpg1);
        localStorage.setItem('cursorupg2', cursorUpg2);
        localStorage.setItem('grandmaupg1', grandmaUpg1);

        setTimeout(storeGameElements, 1000);
    }
